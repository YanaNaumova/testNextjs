    ...
    return (
        <WrapperContainer nameClass={styles.quoteContainer}>
            <Petals nameClassPeals={styles.petalsContainer}
                nameClassTop={styles.leftPealTop} srcPetalTop={"/Vector (7).svg"} widthPetalTop={71} heightPetalTop={54}
                    nameClassMiddle={styles.leftPealMiddle} srcPetalMiddle={"/Vector (9).svg"} widthPetalMiddle={35} heightPetalMiddle={19}
                    nameClassBottom={styles.leftPealBottom} srcPetalBottom={"/Vector (10).svg"} widthPetalBottom={46} heightPetalBottom={26}
            />
            ...
            <WrapperContainer nameClass={styles.header}>
                <WrapperImage nameClass={styles.imageCenter}>
                    <Image src="/Ellipse.svg" width={280} height={280}/>
                </WrapperImage>
                ...
                <Petals nameClassPeals={styles.petalsContainer}
                    nameClassTop={styles.rightPealTop} srcPetalTop={"/Vector (11).svg"} widthPetalTop={113} heightPetalTop={78}
                        nameClassMiddle={styles.rightPealMiddle} srcPetalMiddle={"/Vector (12).svg"} widthPetalMiddle={46} heightPetalMiddle={22}
                        nameClassBottom={styles.rightPealBottom} srcPetalBottom={"/Vector (13).svg"} widthPetalBottom={57} heightPetalBottom={35}
                />
            </WrapperContainer>
    )
}
